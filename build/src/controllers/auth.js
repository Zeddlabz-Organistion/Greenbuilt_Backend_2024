        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4, index_1.prisma.user
                        ...
                        (0, logUser_1.loguser)(userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.id, userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.name, userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.role, "Coporate User has been Approved Successfully", res);
                        return res.status(statusCode_1.statusCode.OK).json({
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, index_1.prisma.user
                                        ...
                                        .then(function (data) {
                                        (0, logUser_1.loguser)(userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.id, userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.name, userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.role, "User points updated by " + data.points + " and total points is " + data.totalPoints, res);
                                        return res.status(statusCode_1.statusCode.OK).json({
