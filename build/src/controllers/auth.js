...
var signout = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                userData = _a.sent();
                (0, logUser_1.loguser)(userData === null || userData === void 0 ? void 0 : userData.id, userData === null || userData === void 0 ? void 0 : userData.name, userData === null || userData === void 0 ? void 0 : userData.role, "user logout Sucessfully!", res);
...
var approveCorporateUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId_1, userData_1, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, 4, 5]);
                userId_1 = +(req.params.userId || '0');
            ...
            case 1:
                ...
                return [4, index_1.prisma.user
                        ...
                        (0, logUser_1.loguser)(userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.id, userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.name, userData_1 === null || userData_1 === void 0 ? void 0 : userData_1.role, "Coporate User id " + userId_1 + " and name " + user.name + " has been Approved Successfully", res);
                        return res.status(statusCode_1.statusCode.OK).json({
...
var updateUserPoints = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, userData_2, points_1, err_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, 4, 5]);
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, index_1.prisma.user
                                        ...
                                        .then(function (data) {
                                        (0, logUser_1.loguser)(userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.id, userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.name, userData_2 === null || userData_2 === void 0 ? void 0 : userData_2.role, "User id is " + data.id + " and name is " + (data === null || data === void 0 ? void 0 : data.name) + " points updated by " + data.points + " and total points is " + data.totalPoints, res);
                                        return res.status(statusCode_1.statusCode.OK).json({
